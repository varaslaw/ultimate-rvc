...
from ultimate_rvc.rvc.realtime.audio import Audio
from ultimate_rvc.rvc.realtime.core import VoiceChanger
...
class AudioCallbacks:
    ...
    def change_voice(
        ...
        try:
            ...
            logger.exception("An error occurred during real-time voice conversion")
