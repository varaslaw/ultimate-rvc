...
from ultimate_rvc.rvc.realtime.core import AUDIO_SAMPLE_RATE
...
def list_audio_device():
    ...
    try:
        ...
        logger.error("An error occurred while querying the audio device: %s", e)
        audio_device_list = []
...
class Audio:
    ...
    def audio_stream_callback(
        ...
        try:
            ...
            logger.exception("An error occurred while running the audio stream")
    ...
    def audio_queue(self, outdata: np.ndarray, frames, times, status):
        try:
            ...
            logger.exception("An error occurred while running the audio queue")
    ...
    def start(
        ...
        try:
            ...
            logger.exception("An error occurred while streaming audio")
